...
Wasn't able to intergrate XGboost. wasn't able to start it in my notebook cause i had a wierd problem where i wasn't able to import my libary.
Also since i converted evrything from my notebook to .py the mean_squared_error function doesn't i don't know why.
